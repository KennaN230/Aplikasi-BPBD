<div class="sidebar">
  ...
  <div class="brand">
    <div class="d-flex align-items-center gap-1">
      ...
      <img src="{{ asset('gambar/Logo 1 1.png') }}" width="30" height="30" alt="logo">
      <div>
  ...
  <ul class="menu">
    ...
    <li>
      <a href="{{ route('Rain') }}" class="{{ request()->routeIs('Rain') ? 'is-active' : '' }}"><i class="bi bi-cloud-rain-heavy"></i><span>Hari Hujan & Tanpa Hujan</span></a>
    </li>
    <li>
